...
class AhorcadoGuarani extends StatefulWidget {
  const AhorcadoGuarani({Key? key}) : super(key: key);

  @override
  _AhorcadoGuarani createState() => _AhorcadoGuarani();
}

class _AhorcadoGuarani extends State<AhorcadoGuarani> {
  String palabra = "Flutter".toUpperCase();
  ...
  Future<String> seleccinarPalabra() async {
    ...
    */
    ...
    print(palabras[pos].guarani);
    return palabras[pos].guarani;
  }
